...
export const GLYPH_STROKES: Record<string, readonly GlyphStroke[]> = {
  ...
  'eiffel-tower': [
    s(0, 'fine', 'M5.6 29 H26.4'),
    s(1, 'heavy', 'M7.2 28.5 L10.4 23.4 Q12.1 20.8 12.7 18'),
    s(1, 'heavy', 'M24.8 28.5 L21.6 23.4 Q19.9 20.8 19.3 18'),
    s(2, 'mid', 'M10.8 28.5 Q12.6 23.6 16 23.6 Q19.4 23.6 21.2 28.5 M7.2 28.5 H10.8 M21.2 28.5 H24.8'),
    s(2, 'mid', 'M9.8 23 H22.2 M10.3 24.2 H21.7 M11.8 17.5 H20.2 M12.1 18.7 H19.9'),
    s(3, 'mid', 'M12.7 17.5 Q14.5 11.6 14.6 6.8'),
    s(3, 'mid', 'M19.3 17.5 Q17.5 11.6 17.4 6.8'),
    s(3, 'fine', 'M13 17.1 L18.1 12.2 L14.7 7.3 M19 17.1 L13.9 12.2 L17.3 7.3 M14 12.2 H18'),
    s(4, 'mid', 'M14.1 6.8 H17.9 M14.2 5.6 H17.8 M14.7 5.6 Q14.7 4.4 15.4 4.2 M17.3 5.6 Q17.3 4.4 16.6 4.2'),
    s(4, 'fine', 'M15.4 4.2 V3.4 Q16 2.8 16.6 3.4 V4.2 M16 3.1 V1.8 M9 25.7 L12 26.2 M23 25.7 L20 26.2'),
  ],
  petra: [
