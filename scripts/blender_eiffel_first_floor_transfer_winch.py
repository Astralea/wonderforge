...
design=json.loads((OUT/'design.json').read_text());scene=bpy.data.scenes.new('WonderForge — cart-ready first-floor receiving winch');bpy.context.window.scene=scene
