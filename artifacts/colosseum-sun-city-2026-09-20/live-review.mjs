...
for(const [mode,width,height] of [['desktop',1280,720],['mobile',390,844]]){
 ...
 await page.screenshot({path:`artifacts/colosseum-sun-city-2026-09-20/${mode}-live-ending.png`});
 ...
 await page.screenshot({path:`artifacts/colosseum-sun-city-2026-09-20/${mode}-live-return.png`});
 results.push({mode,errors,shots,continuous,replayValue,home});await page.close();
}
await writeFile('artifacts/colosseum-sun-city-2026-09-20/validation/live-review.json',JSON.stringify(results,null,2));
