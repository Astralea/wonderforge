...
Resolve sibling skills within the current project:

1. `../<skill-name>/SKILL.md` relative to this skill's directory.
2. `<project-root>/.agents/skills/<skill-name>/SKILL.md`.

Use the directory containing the loaded skill for its resources. These skills are project-scoped; do not fall back to a removed global installation.
