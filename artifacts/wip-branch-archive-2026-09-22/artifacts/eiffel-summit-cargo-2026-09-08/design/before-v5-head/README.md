...
`head-feed-proposal.json` contains exact centres, tangent vectors, and axes. The accepted design uses a 6 m reinforced jib with heel Y307.05, rising to Y311.716667. The cargo drive and all three lower guides remain on m073 for both lifts. The separate pole-climbing drive is on m075.
...
The 6 m jib reaches the upper collar at flat-stock radius5.929660 m. The extreme mast end radius6.039112 m would exceed it. The actual collar offset, fixed tail pivot, and side-feed equations matter; a generic centre hook or unchanged passive two-leg sling cannot produce the upend.
...
|---|---:|---:|
| Minimum tip/block centre separation |1.114028 m|1.114039 m|
| Deployed reference rope |16.557805–65.017217 m|21.224493–79.017217 m|
| Clockwise annular wrap |2.758167–5.862648 rad|2.758167–5.862648 rad|
| Reference wound amount with120 m total |54.982783–103.442195 m|40.982783–98.775507 m|
...
The separate luff restraint needs its own positive head/tip attachments, supported control, continuous path and conserved inventory. Its basic anchor-to-tip distance is `sqrt(L²+h²−2Lh sin(pitch))`; a two-fall tackle changes twice that straight span plus its actual arcs. It does not share the cargo or pole-climbing rope. Luff source clearance, operators, equipment installation/removal and the incoming ground-to-terrace supply remain outside this bounded implementation. No capacity, gear-load sufficiency, section mass, or historical exactness is certified.
